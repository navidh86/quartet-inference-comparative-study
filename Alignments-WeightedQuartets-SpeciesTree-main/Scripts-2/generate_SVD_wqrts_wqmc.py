...
parser.add_argument("-t", "--taxa_mapping_file_name", dest="taxa_mapping_file", help="Taxa Mapping File Name", type=str, required=False, default="alldata.out")
...
taxa_mapping_file = args.taxa_mapping_file
