...
for mode in higher-ILS lower-ILS; do
    for r in {1..20}; do
        ...
        out="/mnt/nvme/1605005-1605006/msc_project/Alignments-WeightedQuartets-SpeciesTree-main/10-taxon/Output/10-taxa-quartet_from_geneTree/${mode}/R${r}-GTF.wqrts"
        # run quartet_controller.sh on the specified gene tree
        ...
        bash quartet-controller.sh ${gt} ${out}
    done
done
#cd ..
