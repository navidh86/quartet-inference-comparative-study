...
output_folder_intron = input_folder_intron 
stree_output_folder = f"{base_folder}/Estimated-Species-Trees/Avian"
wqrts_output_folder = f"{avian_folder}/Output"
...
def prepare_nexus_sequences():
    ...
    output_folder_rep = os.path.join(output_folder_intron, f"all_nexus")
    os.makedirs(output_folder_rep, exist_ok=True)

    for gene in genes:
        input_file_sequences_fasta = os.path.join(input_folder_intron, str(gene), "sate.removed.intron.original.aligned-allgap.filtered")
