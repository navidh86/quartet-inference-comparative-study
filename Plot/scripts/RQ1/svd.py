...
mapping2 = {
    'SVD': 'SVDquartets',
    'wQFM-SVD-exponential': 'wQFM-SVD-Exp', # capitalized the suffixes (12 July, 2024) 
    'wQFM-SVD-reciprocal': 'wQFM-SVD-Rec', # capitalized the suffixes (12 July, 2024)
    'wQMC-SVD-exponential': 'wQMC-SVD-Exp', # capitalized the suffixes (12 July, 2024)
    'wQMC-SVD-reciprocal': 'wQMC-SVD-Rec' # capitalized the suffixes (12 July, 2024)
}
...
out_file = f"{out_dir}/RQ1b-svd-{TAXA}-taxon{variety}" + ".pdf"
out_file_png = f"{out_dir}/RQ1b-svd-{TAXA}-taxon{variety}" + ".png"
out_file_svg = f"{out_dir}/RQ1b-svd-{TAXA}-taxon{variety}" + ".svg"
...
if TAXA == 10:
    ...
    ylim = 0.35
    ytick_lim = 0.4 # upto but not including
elif TAXA == 37:
    if variety == "-ILS":
        ylim = 0.123
        ytick_lim = 0.13
