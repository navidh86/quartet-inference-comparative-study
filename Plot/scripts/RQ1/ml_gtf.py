...
order = ["wQFM-RAxML", 
        f'a{bucky_a}-bucky-mrbayes', f'a{bucky_a}-bucky-RAxML',
        f'a{bucky_a}-wQFM-bucky-mrbayes', f'a{bucky_a}-wQFM-bucky-RAxML',
        "wQFM-GTF", "wQMC-GTF"]
...
# if TAXA != 15:
if True:
    # drop wQFM-RAxML as it is excruciatingly slow for 37
    # and very bad for 10
    # UPDATE (25 June 2024): Dropping it for 15 taxa as well. Will move the figure with wQFM-RAxML to supplementary materials.
    order = order[1:]
...
out_file = f"{out_dir}/RQ1c-ml-bucky-gtf-{TAXA}-taxon{variety}" + ".pdf"
out_file_png = f"{out_dir}/RQ1c-ml-bucky-gtf-{TAXA}-taxon{variety}" + ".png"
out_file_svg = f"{out_dir}/RQ1c-ml-bucky-gtf-{TAXA}-taxon{variety}" + ".svg"
